    ...
    <div>
        ...
        {featured && (
          <Link to={`/auctions/${featured.id}`} style={{ textDecoration: "none" }}>
            ...
            >
              ...
              {/* Image */}
              <div style={{ width: "100%", height: 180, background: "var(--surface-2)", overflow: "hidden" }}>
              ...
              <div style={{ padding: "14px 16px" }}>
                <div style={{ fontSize: "0.82rem", fontWeight: 600, color: "var(--text)", marginBottom: 10, lineHeight: 1.2 }}>
                  {featured.product?.title}
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
                  <div>
                    <div style={{ fontSize: "0.58rem", color: "var(--muted)", fontFamily: "'Barlow Condensed', sans-serif", textTransform: "uppercase", letterSpacing: "0.1em" }}>
                      Current High Bid
                    </div>
                    <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900, fontSize: "1.4rem", color: "var(--text)", lineHeight: 1 }}>
                  ...
                  <div style={{ textAlign: "right" }}>
                    ...
                    <Countdown endDate={featured.end_date} style={{
                      fontFamily: "'Barlow Condensed', sans-serif",
                      fontWeight: 800, fontSize: "0.9rem", color: "var(--lime)",
                    }} />
                  </div>
                </div>
              </div>
      ...
      <div style={{ borderTop: "1px solid var(--border)", padding: "64px 32px" }}>
        <div style={{
          ...
          {[
            { icon: "🔒", title: "Verified Listings", desc: "Every product is reviewed before going live." },
            { icon: "⚡", title: "Real-Time Bidding", desc: "WebSocket-powered live auctions with instant updates." },
            { icon: "🌍", title: "Open Platform", desc: "Anyone can buy or sell — one account, full access." },
            { icon: "🛡️", title: "Secure Auth", desc: "JWT authentication with bcrypt password protection." },
            ...
            <div key={i} style={{
              ...
              <h4 style={{ fontSize: "1rem", fontWeight: 700, marginBottom: 8, color: "var(--text)" }}>
                {title}
              </h4>
