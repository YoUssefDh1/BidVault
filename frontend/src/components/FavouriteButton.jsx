...
export default function FavouriteButton({ auctionId, size = 20 }) {
  ...
  return (
    <button
      ...
      style={{
        background: saved ? "rgba(200,255,0,0.1)" : "rgba(0,0,0,0.5)",
        border: `1px solid ${saved ? "var(--lime)" : "rgba(255,255,255,0.15)"}`,
        borderRadius: "50%",
